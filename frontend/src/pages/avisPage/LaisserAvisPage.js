        ...
        main.innerHTML = `
            <section class="lap-card">
                <div class="lap-header">
                    ...
                    <p>Prenez quelques secondes pour partager votre retour. C’est optionnel, mais très utile pour améliorer les prestations.</p>
                </div>
                ...
                <div class="lap-actions">
                    ...
                    <button class="btn btn-primary" id="lap-submit" type="button">Publier l’avis</button>
                </div>
            </section>
        `;
