...
export const NavbarCoiffeur = () => NavbarLayout([
    { id: 'dashboard', icon: 'layout-dashboard', label: 'Tableau de bord', mobileLabel: 'Tableau', route: '/coiffeur/dashboard' },
    { id: 'rdv', icon: 'calendar', label: 'Mes rendez-vous', mobileLabel: 'Rendez-vous', route: '/coiffeur/rendez-vous' },
